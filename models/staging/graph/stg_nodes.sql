...
select 
    ...
    cast(null as {{ dbt_project_evaluator.type_string_dpe() }}) as incremental_strategy,
    cast(null as {{ dbt_project_evaluator.type_string_dpe() }}) as partition_by,
    cast(null as {{ dbt_project_evaluator.type_string_dpe() }}) as persist_docs,
    cast(null as {{ dbt_project_evaluator.type_string_dpe() }}) as full_refresh,
